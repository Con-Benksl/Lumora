...
"""
Lumora Hook
- Sends session state to Lumora.app via Unix socket
...
def main():
    ...
    if event == "UserPromptSubmit":
        ...
        # Surface that as `waiting_for_input` so Lumora shows the green
        ...
        # it as `waiting_for_input` so Lumora drops the processing
            ...
            if decision == "allow":
                ...
                output = {
                    "hookSpecificOutput": {
                        ...
                        "decision": {
                            "behavior": "deny",
                            "message": reason or "Denied by user via Lumora",
                        },
                    }
                }
                print(json.dumps(output))
