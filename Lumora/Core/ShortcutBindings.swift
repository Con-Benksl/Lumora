...
enum ShortcutAction: String, CaseIterable, Codable {
    ...
    var displayName: String {
        switch self {
        case .toggleNotch:     return String(localized: "Toggle Main Page")
        case .closeNotch:      return String(localized: "Close Notch")
        case .selectPrevious:  return String(localized: "Navigate Up")
        case .selectNext:      return String(localized: "Navigate Down")
        case .enterSession:    return String(localized: "Open")
        case .navigateBack:    return String(localized: "Go Back")
...
private func keyCodeToSymbol(_ keyCode: UInt16) -> String {
    ...
    case 103: return "F11"
    case 111: return "F12"
    default:  return String(localized: "Key\(Int(keyCode))")
    }
}
