...
private let logger = Logger(subsystem: "com.conbenksl.lumora", category: "AgentFileWatcher")
...
class AgentFileWatcher {
    ...
    private let queue = DispatchQueue(label: "com.conbenksl.lumora.agentfilewatcher", qos: .userInitiated)
