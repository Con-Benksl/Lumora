...
private let logger = Logger(subsystem: "com.conbenksl.lumora", category: "Interrupt")
...
class JSONLInterruptWatcher {
    ...
    private let queue = DispatchQueue(label: "com.conbenksl.lumora.interruptwatcher", qos: .userInteractive)
