...
//  normalised OpencodeSessionEvent surface that Lumora's session store consumes.
//
...
final class OpencodeHookAdapter: @unchecked Sendable {
    ...
    nonisolated private static let log = Logger(subsystem: "com.conbenksl.lumora", category: "OpencodeAdapter")
    ...
    /// Convert a raw envelope into zero or more tracked Lumora events.
    /// Returns an empty array for events Lumora does not care about.
    ...
    /// Translate a subagent session's raw envelope into parent-scoped Lumora
