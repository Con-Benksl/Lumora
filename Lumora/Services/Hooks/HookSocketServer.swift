...
private let logger = Logger(subsystem: "com.conbenksl.lumora", category: "Hooks")

/// Mirror to `/tmp/lumora-debug.log` when the debug toggle is enabled.
...
class HookSocketServer {
    ...
    static let socketPath = "/tmp/lumora.sock"
    ...
    private let queue = DispatchQueue(label: "com.conbenksl.lumora.socket", qos: .userInitiated)
