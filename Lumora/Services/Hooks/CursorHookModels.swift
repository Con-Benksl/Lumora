...
//  Lumora
//
//  Cursor hook payloads and the narrow Lumora event surface.
//
...
///
/// The Lumora bridge normally adds `origin: "cursor"` before forwarding the
...
struct CursorHookEnvelope: Decodable, Sendable {
    ...
    var sessionId: String {
        ...
        // `conversation_id` is the stable chat identity Lumora should group by.
