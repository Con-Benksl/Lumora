...
actor SessionStore {
    ...
    nonisolated static let logger = Logger(subsystem: "com.conbenksl.lumora", category: "Session")
    ...
    private func processHookEvent(_ event: HookEvent) async {
        ...
        // DIAGNOSTIC (#14): log every hook event to /tmp/lumora-debug.log so
    ...
    private func recheckAllSessions() {
        ...
        for (sessionId, session) in Array(sessions) {
            ...
            // Claude: when the Stop hook is missed (e.g. lumora-state.py
