...
class ShortcutManager {
    ...
    private func installCarbonEventHandler() {
        ...
        InstallEventHandler(
            ...
            { (_, event, _) -> OSStatus in
                ...
                if hotKeyID.signature == 0x4E4F4F4B { // "LUMORA"
                    Task { @MainActor in
    ...
    func startLocalMonitor() {
        ...
        localMonitor = NSEvent.addLocalMonitorForEvents(matching: .keyDown) { [weak self] event in
            ...
            // Other Lumora windows and native pickers own their keyboard input.
            guard NSApp.modalWindow == nil, NSApp.keyWindow is NotchPanel else { return event }
...
extension Notification.Name {
    static let globalToggleNotch = Notification.Name("com.conbenksl.lumora.globalToggleNotch")
    static let shortcutAction = Notification.Name("com.conbenksl.lumora.shortcutAction")
    static let shortcutKeyDown = Notification.Name("com.conbenksl.lumora.shortcutKeyDown")
    static let chatScrollAction = Notification.Name("com.conbenksl.lumora.chatScrollAction")
}
