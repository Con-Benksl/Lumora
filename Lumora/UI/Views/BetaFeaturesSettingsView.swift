...
struct BetaFeaturesSettingsView: View {
    ...
    var body: some View {
        ScrollView(.vertical, showsIndicators: true) {
            VStack(spacing: 4) {
                ...
                MenuToggleRow(
                    icon: "waveform",
                    label: String(localized: "Audio-Reactive Music Glow"),
    ...
    private func toggleAudioReactiveMusicGlow() {
        ...
        // behind Lumora's compact settings panel.
    ...
    private func handleMusicAudioActivationFailure(_ error: Error) {
        ...
        alert.messageText = String(localized: "Audio-Reactive Music Glow Couldn’t Start")
