...
private extension CompactMusicActivityView {
    ...
    var secondaryText: String {
        ...
        return candidates.first ?? String(localized: "Music")
    }
...
private struct CompactAudioSpectrumView: NSViewRepresentable {
    ...
    func makeNSView(context: Context) -> CompactAudioSpectrum {
        ...
        spectrum.setRealSpectrumLevels(reduceMotion ? nil : realSpectrumLevels)
    ...
    func updateNSView(_ nsView: CompactAudioSpectrum, context: Context) {
        ...
        nsView.setRealSpectrumLevels(reduceMotion ? nil : realSpectrumLevels)
        nsView.setPlaying(isPlaying && !reduceMotion)
    }

    static func dismantleNSView(_ nsView: CompactAudioSpectrum, coordinator: ()) {
