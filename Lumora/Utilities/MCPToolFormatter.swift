...
struct MCPToolFormatter {
    ...
    private static let toolAliases: [String: String] = [
        ...
        "AgentOutputTool": String(localized: "Await Agent"),
        "AskUserQuestion": String(localized: "Question"),
        "TodoWrite": String(localized: "Todo"),
        "TaskUpdate": String(localized: "Todo"),
        "TodoRead": String(localized: "Todo"),
        "WebFetch": String(localized: "Fetch"),
        "WebSearch": String(localized: "Search"),
        "NotebookEdit": String(localized: "Notebook"),
        "BashOutput": "Bash",
        "KillShell": "Shell",
        "EnterPlanMode": String(localized: "Plan"),
        "ExitPlanMode": String(localized: "Plan"),
        "SlashCommand": String(localized: "Command"),
        ...
        "task": String(localized: "Agent"),
        "skill": String(localized: "Skill"),
    ]
